...
set VERSION=1.8.9-forge

:: get archive from natives/ dir
set NATIVES_DIR="%MC_DIR%\natives\1.8.9"

:: set username
set /p PLAYER_NAME=Set a Username: 
